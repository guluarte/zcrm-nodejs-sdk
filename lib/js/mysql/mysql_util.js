...
return new Promise(function(resolve,reject){
    ...
    var sql = "INSERT INTO oauthtokens (useridentifier, accesstoken,refreshtoken,expirytime) VALUES (?, ?, ?, ?)";
    ...
    con.query(sql, [config_obj.user_identifier, config_obj.access_token, config_obj.refresh_token, config_obj.expires_in], function(err,result){
